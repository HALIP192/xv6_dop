...
int main(int argc, char **argv)
{
   ...
   8:	1000                	addi	s0,sp,32
    if (argc < 2) {
   a:	4785                	li	a5,1
   c:	02a7da63          	bge	a5,a0,40 <main+0x40>
  10:	84ae                	mv	s1,a1
  ...
  16:	80650513          	addi	a0,a0,-2042 # 818 <malloc+0x106>
  1a:	00000097          	auipc	ra,0x0
  1e:	640080e7          	jalr	1600(ra) # 65a <printf>
    sleep(atoi(argv[1]));
  22:	6488                	ld	a0,8(s1)
  24:	00000097          	auipc	ra,0x0
  28:	1c2080e7          	jalr	450(ra) # 1e6 <atoi>
  2c:	00000097          	auipc	ra,0x0
  30:	344080e7          	jalr	836(ra) # 370 <sleep>
    return 0;
}
  34:	4501                	li	a0,0
  36:	60e2                	ld	ra,24(sp)
  ...
  44:	7c050513          	addi	a0,a0,1984 # 800 <malloc+0xee>
  48:	00000097          	auipc	ra,0x0
  4c:	612080e7          	jalr	1554(ra) # 65a <printf>
            exit(1);
  50:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3c8:	4dc50513          	addi	a0,a0,1244 # 8a0 <digits>
 3cc:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 488:	3c4c8c93          	addi	s9,s9,964 # 848 <malloc+0x136>
 ...
 496:	40eb8b93          	addi	s7,s7,1038 # 8a0 <digits>
 ...
 5bc:	28898993          	addi	s3,s3,648 # 840 <malloc+0x12e>
        while(*s != 0){
 5c0:	85ee                	mv	a1,s11
