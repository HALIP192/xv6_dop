...
void str_trunc(char *buf)
{
   ...
   c:	84aa                	mv	s1,a0
    ...
    while(buf[i] && !strchr(whitespaces, buf[i]))
   e:	00054583          	lbu	a1,0(a0)
  12:	00001917          	auipc	s2,0x1
  16:	8ae90913          	addi	s2,s2,-1874 # 8c0 <malloc+0xec>
  1a:	c999                	beqz	a1,30 <str_trunc+0x30>
  1c:	854a                	mv	a0,s2
  1e:	00000097          	auipc	ra,0x0
  22:	1ac080e7          	jalr	428(ra) # 1ca <strchr>
  26:	e509                	bnez	a0,30 <str_trunc+0x30>
  28:	0485                	addi	s1,s1,1
  2a:	0004c583          	lbu	a1,0(s1)
  2e:	f5fd                	bnez	a1,1c <str_trunc+0x1c>
        i++;
    buf[i] = 0;
  30:	00048023          	sb	zero,0(s1)
}
  34:	60e2                	ld	ra,24(sp)
  36:	6442                	ld	s0,16(sp)
  38:	64a2                	ld	s1,8(sp)
...
{
  40:	ad010113          	addi	sp,sp,-1328
  44:	52113423          	sd	ra,1320(sp)
  48:	52813023          	sd	s0,1312(sp)
  4c:	50913c23          	sd	s1,1304(sp)
  50:	53010413          	addi	s0,sp,1328
    int i = 1;
  54:	4785                	li	a5,1
  56:	fcf42e23          	sw	a5,-36(s0)
    ...
    while(argv[i]) {
  5a:	659c                	ld	a5,8(a1)
  5c:	cba5                	beqz	a5,cc <main+0x8c>
  5e:	ad840693          	addi	a3,s0,-1320
  62:	05c1                	addi	a1,a1,16
  64:	4709                	li	a4,2
        exe[i - 1] = argv[i];
  66:	e29c                	sd	a5,0(a3)
        i++;
  68:	0007061b          	sext.w	a2,a4
    while(argv[i]) {
  6c:	619c                	ld	a5,0(a1)
  6e:	0705                	addi	a4,a4,1
  70:	06a1                	addi	a3,a3,8
  72:	05a1                	addi	a1,a1,8
  74:	fbed                	bnez	a5,66 <main+0x26>
  76:	fcc42e23          	sw	a2,-36(s0)
  7a:	a889                	j	cc <main+0x8c>
    }

    while (read(0, &buf, sizeof(buf) - 1)) {
        str_trunc(buf);
  7c:	bd840513          	addi	a0,s0,-1064
  80:	00000097          	auipc	ra,0x0
  84:	f80080e7          	jalr	-128(ra) # 0 <str_trunc>
        exe[i - 1] = (char *)malloc(sizeof(buf));
  88:	fdc42483          	lw	s1,-36(s0)
  8c:	34fd                	addiw	s1,s1,-1
  8e:	40000513          	li	a0,1024
  92:	00000097          	auipc	ra,0x0
  96:	742080e7          	jalr	1858(ra) # 7d4 <malloc>
  9a:	048e                	slli	s1,s1,0x3
  9c:	fe048793          	addi	a5,s1,-32
  a0:	008784b3          	add	s1,a5,s0
  a4:	aea4bc23          	sd	a0,-1288(s1)
        strcpy(exe[i++ - 1], buf);
  a8:	fdc42783          	lw	a5,-36(s0)
  ac:	0017871b          	addiw	a4,a5,1
  b0:	fce42e23          	sw	a4,-36(s0)
  b4:	37fd                	addiw	a5,a5,-1
  b6:	078e                	slli	a5,a5,0x3
  b8:	1781                	addi	a5,a5,-32
  ba:	97a2                	add	a5,a5,s0
  bc:	bd840593          	addi	a1,s0,-1064
  c0:	af87b503          	ld	a0,-1288(a5)
  c4:	00000097          	auipc	ra,0x0
  c8:	072080e7          	jalr	114(ra) # 136 <strcpy>
    while (read(0, &buf, sizeof(buf) - 1)) {
  cc:	3ff00613          	li	a2,1023
  d0:	bd840593          	addi	a1,s0,-1064
  d4:	4501                	li	a0,0
  d6:	00000097          	auipc	ra,0x0
  da:	2e4080e7          	jalr	740(ra) # 3ba <read>
  de:	fd59                	bnez	a0,7c <main+0x3c>
    }

    int pid = fork();
  e0:	00000097          	auipc	ra,0x0
  e4:	2ba080e7          	jalr	698(ra) # 39a <fork>
    if (!pid) {
  e8:	c10d                	beqz	a0,10a <main+0xca>
        exec(exe[0], exe);
    }
    wait(&i);
  ea:	fdc40513          	addi	a0,s0,-36
  ee:	00000097          	auipc	ra,0x0
  f2:	2bc080e7          	jalr	700(ra) # 3aa <wait>

    return 0;
}
  f6:	4501                	li	a0,0
  f8:	52813083          	ld	ra,1320(sp)
  fc:	52013403          	ld	s0,1312(sp)
 100:	51813483          	ld	s1,1304(sp)
 104:	53010113          	addi	sp,sp,1328
 108:	8082                	ret
        exec(exe[0], exe);
 10a:	ad840593          	addi	a1,s0,-1320
 10e:	ad843503          	ld	a0,-1320(s0)
 112:	00000097          	auipc	ra,0x0
 116:	2c8080e7          	jalr	712(ra) # 3da <exec>
 11a:	bfc1                	j	ea <main+0xaa>
...
_main()
{
 ...
 128:	f1c080e7          	jalr	-228(ra) # 40 <main>
  exit(0);
 12c:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 48a:	4a250513          	addi	a0,a0,1186 # 928 <digits>
 48e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 54a:	38ac8c93          	addi	s9,s9,906 # 8d0 <malloc+0xfc>
 ...
 558:	3d4b8b93          	addi	s7,s7,980 # 928 <digits>
 ...
 67e:	24e98993          	addi	s3,s3,590 # 8c8 <malloc+0xf4>
        while(*s != 0){
 682:	85ee                	mv	a1,s11
...
malloc(uint nbytes)
{
 ...
 8ae:	b80080e7          	jalr	-1152(ra) # 42a <sbrk>
  if(p == (char*)-1)
