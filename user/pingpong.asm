...
int main(void)
{
  ...
  10:	3e0080e7          	jalr	992(ra) # 3ec <pipe>
  ...
  20:	3d0080e7          	jalr	976(ra) # 3ec <pipe>
  24:	e141                	bnez	a0,a4 <main+0xa4>
        printf("pipe(p2) failed.\n");
        return 1;
    }
    int fd = fork();
  26:	00000097          	auipc	ra,0x0
  2a:	3ae080e7          	jalr	942(ra) # 3d4 <fork>

    if (fd) {
  2e:	c155                	beqz	a0,d2 <main+0xd2>
        close(p1[0]); // закрываем "трубу" на чтение в 1 из пар
  30:	fe842503          	lw	a0,-24(s0)
  34:	00000097          	auipc	ra,0x0
  38:	3d0080e7          	jalr	976(ra) # 404 <close>
        write(p1[1], "p", 1); // в "трубу" для записи из 1 пары посылаем байтик
  3c:	4605                	li	a2,1
  3e:	00001597          	auipc	a1,0x1
  42:	8f258593          	addi	a1,a1,-1806 # 930 <malloc+0x122>
  46:	fec42503          	lw	a0,-20(s0)
  4a:	00000097          	auipc	ra,0x0
  4e:	3b2080e7          	jalr	946(ra) # 3fc <write>

        wait((void *)0); // ждем пока ребенок закончит исполнение
  52:	4501                	li	a0,0
  54:	00000097          	auipc	ra,0x0
  58:	390080e7          	jalr	912(ra) # 3e4 <wait>

        close(p2[1]); // закрываем конец 2 "трубы" на запись
  5c:	fe442503          	lw	a0,-28(s0)
  60:	00000097          	auipc	ra,0x0
  64:	3a4080e7          	jalr	932(ra) # 404 <close>

        char mail_child;
        read(p2[0], &mail_child, 1);
  68:	4605                	li	a2,1
  6a:	fdf40593          	addi	a1,s0,-33
  6e:	fe042503          	lw	a0,-32(s0)
  72:	00000097          	auipc	ra,0x0
  76:	382080e7          	jalr	898(ra) # 3f4 <read>
        if (mail_child) {
  7a:	fdf44783          	lbu	a5,-33(s0)
  7e:	ef85                	bnez	a5,b6 <main+0xb6>
                printf("%d: received pong\n", getpid());
        }
        exit(0);
  80:	4501                	li	a0,0
  82:	00000097          	auipc	ra,0x0
  86:	35a080e7          	jalr	858(ra) # 3dc <exit>
        printf("pipe(p1) failed.\n");
  8a:	00001517          	auipc	a0,0x1
  8e:	87650513          	addi	a0,a0,-1930 # 900 <malloc+0xf2>
  ...
  a8:	87450513          	addi	a0,a0,-1932 # 918 <malloc+0x10a>
  ac:	00000097          	auipc	ra,0x0
  b0:	6aa080e7          	jalr	1706(ra) # 756 <printf>
        return 1;
  b4:	b7dd                	j	9a <main+0x9a>
                printf("%d: received pong\n", getpid());
  b6:	00000097          	auipc	ra,0x0
  ba:	3a6080e7          	jalr	934(ra) # 45c <getpid>
  be:	85aa                	mv	a1,a0
  c0:	00001517          	auipc	a0,0x1
  c4:	87850513          	addi	a0,a0,-1928 # 938 <malloc+0x12a>
  c8:	00000097          	auipc	ra,0x0
  cc:	68e080e7          	jalr	1678(ra) # 756 <printf>
  d0:	bf45                	j	80 <main+0x80>
        close(p1[1]); //закрываем "турубу" на запись из 1 пары
  d2:	fec42503          	lw	a0,-20(s0)
  d6:	00000097          	auipc	ra,0x0
  da:	32e080e7          	jalr	814(ra) # 404 <close>
        read(p1[0], &mail_parent, 1);
  de:	4605                	li	a2,1
  e0:	fdf40593          	addi	a1,s0,-33
  e4:	fe842503          	lw	a0,-24(s0)
  e8:	00000097          	auipc	ra,0x0
  ec:	30c080e7          	jalr	780(ra) # 3f4 <read>
        if (mail_parent) {
  f0:	fdf44783          	lbu	a5,-33(s0)
  f4:	e3b9                	bnez	a5,13a <main+0x13a>
        close(p1[0]);
  f6:	fe842503          	lw	a0,-24(s0)
  fa:	00000097          	auipc	ra,0x0
  fe:	30a080e7          	jalr	778(ra) # 404 <close>
        close(p2[0]);
 102:	fe042503          	lw	a0,-32(s0)
 106:	00000097          	auipc	ra,0x0
 10a:	2fe080e7          	jalr	766(ra) # 404 <close>
        write(p2[1], "p", 1);
 10e:	4605                	li	a2,1
 110:	00001597          	auipc	a1,0x1
 114:	82058593          	addi	a1,a1,-2016 # 930 <malloc+0x122>
 118:	fe442503          	lw	a0,-28(s0)
 11c:	00000097          	auipc	ra,0x0
 120:	2e0080e7          	jalr	736(ra) # 3fc <write>
        close(p2[1]);
 124:	fe442503          	lw	a0,-28(s0)
 128:	00000097          	auipc	ra,0x0
 12c:	2dc080e7          	jalr	732(ra) # 404 <close>
        exit(0);
 130:	4501                	li	a0,0
 132:	00000097          	auipc	ra,0x0
 136:	2aa080e7          	jalr	682(ra) # 3dc <exit>
                printf("%d: received ping\n", getpid());
 13a:	00000097          	auipc	ra,0x0
 13e:	322080e7          	jalr	802(ra) # 45c <getpid>
 142:	85aa                	mv	a1,a0
 144:	00001517          	auipc	a0,0x1
 148:	80c50513          	addi	a0,a0,-2036 # 950 <malloc+0x142>
 14c:	00000097          	auipc	ra,0x0
 150:	60a080e7          	jalr	1546(ra) # 756 <printf>
 154:	b74d                	j	f6 <main+0xf6>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4c4:	50850513          	addi	a0,a0,1288 # 9c8 <digits>
 4c8:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 584:	3f0c8c93          	addi	s9,s9,1008 # 970 <malloc+0x162>
 ...
 592:	43ab8b93          	addi	s7,s7,1082 # 9c8 <digits>
 ...
 6b8:	2b498993          	addi	s3,s3,692 # 968 <malloc+0x15a>
        while(*s != 0){
 6bc:	85ee                	mv	a1,s11
